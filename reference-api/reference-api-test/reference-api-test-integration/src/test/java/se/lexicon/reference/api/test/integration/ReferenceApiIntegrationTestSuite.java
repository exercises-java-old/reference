...
@RunWith(Suite.class)
@Suite.SuiteClasses({
        InstrumentApiClientClientIntegrationTest.class
})
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class ReferenceApiIntegrationTestSuite {
    ...
    public static SpringContextRule getComponentRule() {
        if (COMPONENT_TEST_RULE == null) {
            ...
            COMPONENT_TEST_RULE.addXmlConfiguration("reference-component-dao.xml");
            COMPONENT_TEST_RULE.addXmlConfiguration("reference-component-service.xml");
            COMPONENT_TEST_RULE.addXmlConfiguration("reference-component-test-space.xml");
            COMPONENT_TEST_RULE.addXmlConfiguration("reference-component-test-export.xml");
    ...
    public static SpringContextRule getApiRule() {
        if (API_TEST_RULE == null) {
            ...
            API_TEST_RULE.addXmlConfiguration("reference-component-client.xml");
            API_TEST_RULE.addXmlConfiguration("reference-component-test-import.xml");
            API_TEST_RULE.addXmlConfiguration("reference-api-server.xml");
            API_TEST_RULE.addXmlConfiguration("reference-api-server-export.xml");
