...
public class ReferenceComponentOrderBookClientIntegrationTest {
    ...
    public void testGetOrderBookClient() {
        OrderBookClient orderBookClient = ReferenceComponentServiceIntegrationTestSuite
                .getImportContext().getBean(OrderBookClient.class);
        Assert.assertNotNull(orderBookClient);
    }

    @Test
    public void testCreatingOrderBook() {
        OrderBookClient orderBookClient = ReferenceComponentServiceIntegrationTestSuite.getImportContext()
                .getBean(OrderBookClient.class);
        ...
        Assert.assertEquals(1, ReferenceComponentServiceIntegrationTestSuite.getExportContext()
                .getBean(GigaSpace.class).count(OrderBookEntity.templateBuilder().build()));
    }
